...
<aside
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0 d-flex text-wrap align-items-center" href=" {{ route('dashboard') }} ">
            <img src="{{ asset('assets') }}/img/4ps-logo.png" class="navbar-brand-img h-100" alt="main_logo">
            <span class="ms-2 font-weight-bold text-white">SWDI Admin</span>
        </a>
    </div>
        ...
        <li class="nav-item mt-3">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'tables' ? ' active bg-gradient-primary' : '' }} "
                    ...
                    <span class="nav-link-text ms-1">List of Beneficiaries</span>
                </a>
            </li>
            <li class="nav-item">
